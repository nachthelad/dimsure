export const es = {
  ...
  search: {
    ...
    subtitle: "Encuentra productos por nombre, SKU, marca o dimensiones",
    placeholder: "Buscar por SKU, nombre del producto o marca...",
    searching: "Buscando...",
    resultsCount: "productos encontrados",
    showingFirst20: "Mostrando primeros 20 resultados",
    noResults: "No se encontraron productos",
    noProducts: "No hay productos disponibles",
    tryDifferent: "Intenta ajustar tus términos de búsqueda o filtros",
    beFirst: "¡Sé el primero en agregar un producto a la base de datos!",
    sortBy: "Ordenar por",
    sort: {
      name: "Nombre",
  ...
  editProduct: {
    ...
    fields: {
      ...
      weight: "Peso",
      weightPlaceholder: "Ingresar peso (ej., 250g, 1.5lb)",
