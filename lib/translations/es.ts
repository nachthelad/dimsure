export const es = {
    ...
    addProduct: {
      ...
      validation: {
        ...
        nameMaxLength: "El nombre del producto debe tener menos de 100 caracteres",
      ...
      converter: {
        title: "Convertidor de Dimensiones",
        ...
        insert: "Insertar",
        allFieldsRequired: "Todos los campos de dimensiones son requeridos",
        positiveNumbers: "Todas las dimensiones deben ser números positivos",
        errorInToMm: "No se pueden convertir pulgadas a mm cuando el formulario está configurado en pulgadas. Por favor usa el preset 'MM a Pulgadas'.",
        errorMmToIn: "No se pueden convertir mm a pulgadas cuando el formulario está configurado en mm. Por favor usa el preset 'Pulgadas a MM'.",
      },
    },
    myContributions: {
    ...
    disputes: {
      ...
      subtitle: "Ayuda a resolver desacuerdos de mediciones y mejora la calidad de los datos",
      reportIssue: "Reportar Problema",
      admin: "Admin",
      tabs: {
        all: "Todas",
      ...
      modal: {
        ...
        currentWeightPlaceholder: "Peso actual en la base de datos (ej., 250g)",
        proposedValue: "Valor Propuesto",
        correctValue: "Valor Correcto",
        proposedWeight: "Peso Propuesto",
        correctWeight: "Peso Correcto",
        proposedValuePlaceholder: "Cuál debería ser la medida (ej., 150 × 75 × 8 mm)",
        proposedWeightPlaceholder: "Cuál debería ser el peso (ej., 300g)",
        description: "Descripción",
        descriptionPlaceholder: "Explica el problema en detalle...",
        descriptionPlaceholderSuggest: "Explica el problema y por qué crees que necesita corrección...",
        evidenceSource: "Evidencia/Fuente",
        evidenceSourcePlaceholder: "Proporciona fuentes o evidencia para tu corrección...",
        evidenceSourcePlaceholderSuggest: "Proporciona fuentes o evidencia para tu corrección (ej., documentación oficial, medidas manuales)...",
        ...
        validation: {
          ...
          titleRequiredSuggest: "Por favor proporciona un título para la sugerencia.",
          ...
          valuesRequired: "Para disputas de medidas/peso, proporciona tanto el valor actual como el propuesto.",
          productNotFound: "Producto no encontrado. Por favor verifica el SKU.",
        },
        success: {
          disputeSubmitted: "¡Tu disputa ha sido enviada exitosamente!",
          suggestionSubmitted: "¡Tu sugerencia ha sido enviada exitosamente! Gracias por ayudar a mejorar la calidad de nuestros datos.",
        },
        errors: {
          submitFailed: "Error al enviar la disputa. Por favor intenta de nuevo.",
          submitFailedSuggest: "Error al enviar la sugerencia. Por favor intenta de nuevo.",
          imageUploadFailed: "Error al Subir Imagen",
          imageUploadFailedDesc: "Error al subir la imagen de evidencia, pero la disputa se enviará sin ella.",
        },
      },
    },
    editProduct: {
      title: "Editar Producto",
      subtitle: "Realiza cambios en campos individuales y guárdalos de uno en uno",
      ...
      fields: {
        ...
        weight: {
          title: "Peso",
          placeholder: "Ingresar peso (ej., 250g, 1.5kg)",
        },
        dimensions: {
