export const en = {
    ...
    converter: {
      ...
      insert: "Insert",
      allFieldsRequired: "All dimension fields are required",
      positiveNumbers: "All dimensions must be positive numbers",
      errorInToMm: "Cannot convert inches to mm when the form is set to inches. Please use the 'MM to Inches' preset.",
      errorMmToIn: "Cannot convert mm to inches when the form is set to mm. Please use the 'Inches to MM' preset.",
    },
      success: {
    ...
    blog: {
      title: "Dimsure Blog",
      subtitle: "Articles and tips about packaging, logistics and Dimsure updates.",
    ...
    disputes: {
      ...
      modal: {
        ...
        currentWeightPlaceholder: "Current weight in the database (e.g., 250g)",
        proposedValue: "Proposed Value",
        correctValue: "Correct Value",
        proposedWeight: "Proposed Weight",
        correctWeight: "Correct Weight",
        proposedValuePlaceholder: "What the measurement should be (e.g., 150 × 75 × 8 mm)",
        proposedWeightPlaceholder: "What the weight should be (e.g., 300g)",
        description: "Description",
        descriptionPlaceholder: "Explain the issue in detail...",
        descriptionPlaceholderSuggest: "Explain the issue and why you think it needs correction...",
        evidenceSource: "Evidence/Source",
        evidenceSourcePlaceholder: "Provide sources or evidence for your correction...",
        evidenceSourcePlaceholderSuggest: "Provide sources or evidence for your correction (e.g., official documentation, manual measurements)...",
        ...
        validation: {
          ...
          valuesRequired: "For measurement/weight disputes, please provide both current and proposed values.",
          productNotFound: "Product not found. Please check the SKU.",
        },
        success: {
          disputeSubmitted: "Your dispute has been submitted successfully!",
          suggestionSubmitted: "Your suggestion has been submitted successfully! Thank you for helping improve our data quality.",
        },
        errors: {
          ...
          imageUploadFailedDesc: "Failed to upload evidence image, but dispute will be submitted without it.",
        },
      },
    },
    editProduct: {
      ...
      fields: {
        ...
        weight: {
          title: "Weight",
          placeholder: "Enter weight (e.g., 250g, 1.5kg)",
        },
        dimensions: {
          title: "Dimensions (mm)",
          length: "Length",
