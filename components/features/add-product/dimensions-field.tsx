...
export function DimensionsField({ length, width, height, onChange, onPaste, error, unit, t }: DimensionsFieldProps) {
  return (
        ...
        <Label className="flex items-center gap-1">
          ...
          <div className="flex gap-2 items-end flex-1">
            <Input
              ...
              onPaste={onPaste}
              className={`w-full sm:w-24 ${error ? "border-red-500 focus:border-red-500" : ""}`}
              required
            />
